...
/***/ (function(module, exports, __webpack_require__) {
	...
	var tetris = new _tetris2.default();

	var remote = new _remote2.default();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Base = function () {
		...
		_createClass(Base, [{
			...
			key: 'produceNext',
			value: function produceNext() {
				var self = this;
				self.cur = self.next;
				self.next = _squareFactory2.default.prototype.make(Base.getRandom(0, 7), Base.getRandom(0, 4));
				self.setData(self.cur, self.gameData);
			}
			...
			key: 'init',
			value: function init(doms) {
				var self = this;
				var gameContain = doms.gameDiv;
				var nextContain = doms.nextDiv;
				self.next = _squareFactory2.default.prototype.make(Base.getRandom(0, 6), Base.getRandom(0, 3));
				self.produceNext();
	    ...
	    _createClass(Remote, [{
	        ...
	        value: function bindKeyEvent() {
	            ...
	            document.getElementById("remote_initDiv").onclick = function () {
	                _base2.default.initDiv(doms.gameDiv, self.gameDivs, self.gameData);
	            };
